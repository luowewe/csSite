...
const setup = async () => {
  ...
  document.getElementById('final-instructions').hidden = false;

  document.querySelector('#final-instructions button').onclick = (e) => {
    document.getElementById('final-instructions').hidden = true;
  };

  document.querySelector('#help-icon').onclick = (e) => {
    console.log('hello');
    const inst = document.getElementById('final-instructions');
