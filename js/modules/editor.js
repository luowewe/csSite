...
const editor = (id, language) => {
  ...
  // Normal window resizes
  window.addEventListener('resize', fixLayout);

  // Kludge custom event we can use when, e.g. we collapse and rexpand instructions,
  window.addEventListener('reflowPlease', fixLayout);
